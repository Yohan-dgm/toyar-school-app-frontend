...
const SchoolFacilitiesModal = forwardRef<Modalize>((_, ref) => {
  return (
    <Modalize
      ref={ref}
      modalTopOffset={0}
    ...
    >
      <View style={styles.container}>
        <Text style={styles.placeholder}>School Facilities Management</Text>
...
export default SchoolFacilitiesModal;
