    ...
    try {
      ...
      if (filters?.educator) {
        filteredFeedback = filteredFeedback.filter((feedback) =>
          feedback.educatorName
            .toLowerCase()
            .includes(filters.educator.toLowerCase()),
        );
      }
...
// Selectors
export const selectStudentGrowthMetrics = (state) =>
  state.studentGrowth.metrics;
export const selectSelectedMetric = (state) =>
  state.studentGrowth.selectedMetric;
export const selectEducatorFeedback = (state) => state.studentGrowth.feedback;
export const selectFeedbackFilters = (state) =>
  state.studentGrowth.feedbackFilters;
export const selectAttendanceData = (state) => state.studentGrowth.attendance;
export const selectAttendancePeriod = (state) =>
  state.studentGrowth.attendancePeriod;
export const selectStudentGrowthLoading = (state) =>
  state.studentGrowth.loading;
